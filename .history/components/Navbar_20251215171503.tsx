...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm dark:bg-gray-900 dark:border-gray-800">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex items-center justify-between py-4 border-b border-gray-200">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-2xl md:text-3xl font-normal text-gray-900 leading-tight dark:text-gray-50">News</span>
                <span className="text-xl md:text-2xl font-bold text-gray-900 leading-tight dark:text-gray-50">Line</span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-4">
              <Phone className="w-5 h-5 text-gray-600 hidden md:block dark:text-gray-300" />
              <button
                onClick={toggleTheme}
          ...
          <div className="hidden lg:flex items-center justify-center gap-2 py-2 overflow-x-auto">
            <Link
              href="/"
            ...
            {categories.map((category) => (
              ...
              >
                ...
                {category.subcategories && openDropdown === category.name && (
                  <div className="absolute top-full left-0 mt-2 bg-white shadow-lg rounded-md py-2 min-w-[200px] z-50 border border-gray-200 dark:bg-gray-900 dark:border-gray-700">
