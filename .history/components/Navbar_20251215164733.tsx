              ...
              <form onSubmit={handleSearch} className="flex-1">
                ...
                <input
                  ...
                  onChange={(e) => setSearchQuery(e.target.value)}
                    className="w-full px-4 py-2 pl-10 border border-gray-300 rounded-md text-gray-800 focus:outline-none focus:border-yellow-600 focus:ring-1 focus:ring-yellow-600 transition-all text-sm"
                />
            ...
            <Link
              ...
              className={`px-2 py-2 font-bold text-sm uppercase transition-colors border-b-2 ${
                isActive('/')
                  ...
                  : 'text-gray-700 border-transparent hover:text-gray-900 hover:border-yellow-600'
              }`}
            >
              WORLD
            </Link>
